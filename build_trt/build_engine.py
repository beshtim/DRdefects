...
from build_trt.image_batcher import ImageBatcher
...
if __name__ == "__main__":
    ...
    # builder.create_network("/workspace/convertation_files/gr_resnet50.onnx")
    # builder.create_engine("GR_int8.trt", "int8", "/workspace/defectdetector/data/images", "./calibration.cache", 123, 1)
    # builder.create_engine("GR_fp32.trt", "fp32")
    ...
    parser.add_argument("-p", "--precision", default="fp16", choices=["fp32", "fp16", "int8"],
                        help="The precision mode to build in, either 'fp32', 'fp16' or 'int8'")
    parser.add_argument("-v", "--verbose", action="store_true", help="Enable more verbose log output")
    parser.add_argument("-w", "--workspace", default=8, type=int, help="The max memory workspace size to allow in Gb")
    parser.add_argument("--calib_input", help="The directory holding images to use for calibration", default="/workspace/defectdetector/data/images")
    ...
    parser.add_argument("--calib_num_images", default=1077, type=int,
